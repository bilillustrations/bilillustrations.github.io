angular.module('app')
    ...
    .factory("projectsFactory", function () {
        return [
            ...
            { id: 2, categoryId: 2, slug: 'imbratisatoarea',  order: 3, images: [6,6,4,4,4,8,4,5,7,7,5,6,6,6,6], 
                imagesUrls: [
            ...
            { id: 5, categoryId: 3, slug: 'magic-box',  order: 5, images: [12, 6, 6], imagesUrls: ["https://drive.google.com/uc?export=view&id=1rxeHJDN7I_AOApmV3PoZYzMwsLoBkLdI", "https://drive.google.com/uc?export=view&id=1RwQG9K0f6u28xRgnZ3A3ZGkLKEpRug6W", "https://drive.google.com/uc?export=view&id=1njnFhHrh6v3KSnOju4lE9noB0TYyee-V"]  },
